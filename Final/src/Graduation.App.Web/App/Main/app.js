            ...
            if (abp.auth.hasPermission('Pages.Users')) {
                $stateProvider
                    .state('users', {
                        ...
                        menu: 'Users' //Matches to name of 'Users' menu in AppNavigationProvider
                    });
            ...
            if (abp.auth.hasPermission('Pages.Roles')) {
                $stateProvider
                    .state('roles', {
                        ...
                        menu: 'Roles' //Matches to name of 'Tenants' menu in AppNavigationProvider
                    });
            ...
            if (abp.auth.hasPermission('Pages.Tenants')) {
                $stateProvider
                    .state('tenants', {
                        ...
                        menu: 'Tenants' //Matches to name of 'Tenants' menu in AppNavigationProvider
                    });
